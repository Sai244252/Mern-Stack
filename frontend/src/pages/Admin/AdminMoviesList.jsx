  ...
  return (
    <div className="container mx-[9rem]">
      <div className="flex flex-column md:flex-row">
        <div className="p-3 ml-[2rem] text-2xl font-bold h-12">
              ...
              <div className="flex">
                ...
                >
                  ...
                  <div className="px-6 py-4 border border-gray-400">
                    <div className="font-bold tex-xl mb-2">{movie.name}</div>
                  </div>

                  <p className="text-white-600 text-base">{movie.detail}</p>
